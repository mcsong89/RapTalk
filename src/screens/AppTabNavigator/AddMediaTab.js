...
const ICON_RECORD_BUTTON = new REC_Icon(require('../../../assets/images/record_button.png'), 70, 119);
const ICON_RECORDING = new REC_Icon(require('../../../assets/images/record_icon.png'), 20, 14);

const ICON_PLAY_BUTTON = new REC_Icon(require('../../../assets/images/play_button.png'), 34, 51);
const ICON_PAUSE_BUTTON = new REC_Icon(require('../../../assets/images/pause_button.png'), 34, 51);
const ICON_STOP_BUTTON = new REC_Icon(require('../../../assets/images/stop_button.png'), 22, 22);

const ICON_MUTED_BUTTON = new REC_Icon(require('../../../assets/images/muted_button.png'), 67, 58);
const ICON_UNMUTED_BUTTON = new REC_Icon(require('../../../assets/images/unmuted_button.png'), 67, 58);

const ICON_TRACK_1 = new REC_Icon(require('../../../assets/images/track_1.png'), 166, 5);
const ICON_THUMB_1 = new REC_Icon(require('../../../assets/images/thumb_1.png'), 18, 19);
const ICON_THUMB_2 = new REC_Icon(require('../../../assets/images/thumb_2.png'), 15, 19);
...
export default class AddMediaTab extends Component {
    ...
    _askForPermissions = async () => {
      const { status } = await Permissions.askAsync(Permissions.AUDIO_RECORDING);
       if (status === 'granted') {
         ...
         throw new Error('Audio Record permission not granted');
       }
    ...
    async _stopPlaybackAndBeginRecording() {
      ...
      try {
        ...
        console.log(`Audio start error: ${JSON.stringify(error)}`);
      }
    }
        ...
        <View style={styles.container}>
          ...
          {/* <View
            ...
            <View style={[styles.saveButton,
                ...
                <Button style={{width: "30%"}} onPress={() => this.saveMusic()} iconLeft primary>
