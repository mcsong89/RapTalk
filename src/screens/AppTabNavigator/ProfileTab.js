                ...
                <Content>
                        ...
                        <View style={{flex:3}}>
                            ...
                            <View style={{flexDirection:'row'}}>
                                <Button bordered dark
                                    style={{flex:4, marginLeft:10, justifyContent:'center', height:35, marginTop:10}}>
                                    <Text>Edit Profile</Text>
                                </Button>
                                <Button bordered dark small icon
                                 style={{flex:1, marginRight:10, marginLeft:5, justifyContent:'center', height:35, marginTop:10}}>
                                    <Icon name="settings" />
                                </Button>
                            </View>
                        </View>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent:'space-around', borderTopWidth:1,borderTopColor:'#eae5e5' }}>
                        <Button transparent
                            ...
                            <Icon name='ios-apps' 
                                style={[ this.state.activeIndex === 0 ? {color: '#007aff'} : {color: 'grey'} ]}/>
                        </Button>
                        <Button transparent
                                onPress={() => this.segmentClicked(1)}
                            active={this.state.activeIndex === 1}>
                            <Icon name='ios-list' 
                                style={[ this.state.activeIndex === 1 ? {color: '#007aff'} : {color: 'grey'} ]}/>
                        </Button>
                        <Button transparent
                                onPress={() => this.segmentClicked(2)}
                            active={this.state.activeIndex === 2}>
                            <Icon name='ios-people' 
                                style={[ this.state.activeIndex === 2 ? {color: '#007aff'} : {color: 'grey'} ]}/>
                        </Button>
                        <Button transparent
                                onPress={() => this.segmentClicked(3)}
                            active={this.state.activeIndex === 3}>
                            <MaterialIcons name='library-music' size={20}
                                style={[ this.state.activeIndex === 3 ? {color: '#007aff'} : {color: 'grey'} ]}/>
                        </Button>
                    </View>
